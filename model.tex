...
register $\reg{}$ or an immediate value $\word$, 
...
Note, the immediate value is a word, and not 
allowed to be an address in our work.   
		...
		\begin{minipage}[b]{1\textwidth}
            ...
            \begin{minipage}{1\textwidth}
                ...
                }
                {
                    ...
                    \quad
                    \RFile'' =
                      \fsubst{\RFile'}{\reg{d}}{\RFile(\reg{s}) \!+\! \word}
                }
                \vspace{0.3cm}
                \infer
                {
...
$\val_2$ is an offset. This is explain why the 
