...
Here, $\lv[1]$ and $\lv[2]$ shouldn't be a memory address, 
because summing a value and an address is illegal. 
$\lv[3]$ also shouldn't be a memory address, because it 
records a return code pointer, which is a word $\lab{}$. 
