...
it's a pointer in code heap, or an memory address, if it's a location 
of memory. 
\[
	...
	\[
		...
		\begin{array}{ll}
			...
			\begin{array}{lcl}
                ...
                \lambda \, \lv.\, %\\
                %\;
				%\exists \; x, y, z, \lab{\text{ret}}. \\
%				& &
%				{\langle \lv = x \dbCons y \dbCons z
%                  \dbCons \lab{\text{ret}} \dbCons \text{nil} \rangle} \\
...
%				& &
		...
		\end{array}
	\]
	\caption{Example for Function Specification}
