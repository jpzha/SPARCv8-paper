\begin{tikzpicture}[scale=0.7]
    ...
    \fill[pattern=north east lines] (0,0) -- (0,-1cm) arc (-90:-135:1cm) -- (0,0);
    ...
    \draw[->, line width=0.5pt] (-1, -1.1) -- (-0.5, -0.9);
    ...
    \node(regwin) at (0, -1.7) {\scriptsize Register Windows};

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    \fill[black!50] (2, -1.2) rectangle (3.5, -1.7);
    \fill[black!50] (2, -1.7) rectangle (3.5, -2.2);
    ...
    \fill[gray!20] (6, 0.8) rectangle (6.5, 0.3);
    \fill[gray!20] (6, 0.3) rectangle (6.5, -0.2);
    \fill[black!50] (6, -0.2) rectangle (6.5, -0.7);
    \fill[black!50] (6, -0.7) rectangle (6.5, -1.2);
