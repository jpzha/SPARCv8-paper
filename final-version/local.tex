...
\newcommand\eg[0]{\text{e.g.,}}
\newcommand\ie[0]{\text{i.e.,}}
\newcommand{\Def}[1]{\text{Definition} {#1}}
...
\newcommand\nextcwp[0]{\textsf{next\_cwp}}
\newcommand\prevcwp[0]{\textsf{prev\_cwp}}
\newcommand{\precwp}{\nextcwp}
\newcommand{\postcwp}{\prevcwp}
%\newcommand{\precwp}{\textbf{pre\_cwp}}
%\newcommand{\postcwp}{\textbf{post\_cwp}}

\newcommand{\winmask}{\textsf{win\_mask}}
\newcommand{\setwin}{\textsf{set\_win}}

\newcommand{\setdelay}{\textsf{set\_delay}}
\newcommand{\exedelay}{\textsf{exe\_delay}}
...
\newcommand{\decwin}[1]{\textsf{save}{#1}}
\newcommand{\incwin}[1]{\textsf{restore}{#1}}
%
...
\newcommand{\winvalid}[1]{\textsf{win\_valid}{#1}}
...
\newcommand{\sepline}{\; | \;}
\newcommand{\wordaligned}[1]{\textsf{word\_align}{#1}}
...
\newcommand{\Sec}[1]{\text{Section} {#1}}
\newcommand{\Subsec}[1]{\text{Subsection} {#1}}
...
\newcommand{\hexeci}[3]{\textsf{exec}({#1}, {#2}, {#3})}
\newcommand{\lexeci}[3]{\textsf{exec}_{\textsf{L}}({#1}, {#2}, {#3})}
\newcommand{\arguments}{\textsf{args}}
...
\newcommand{\SaveUsedWin}{\texttt{Save}\_\texttt{Usedwindows}}
...
\newcommand{\ctxrefine}{\sqsubseteq}