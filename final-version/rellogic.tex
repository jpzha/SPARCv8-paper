...
in the Coq implementation or technical report, 
...
windows and stack in memory, shown
in 
...
whose context is saved in the register
windows currently, should point to the top of its stack frame
...
We require that the execution of the client code
...
\begin{itemize}
    ...
    execution does not operate register window,
    ...
    of register windows into stack (in memory).
\end{itemize}
...
register file and memory in the high level.
...
Third, there is an {\it invariant}
...
definition is omitted here, to say that $\relastP_r$ is 
...
we show that our logic ensures the simulation relations 
...
which says that our simulation for functions implies
