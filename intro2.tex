...
Just having a traditional Hoare-style program logic 
...
\begin{itemize}
	\item
    We propose a traditional Hoare-style program logic 
    for \sparc{} and support all the above features of \sparc 
...
Then we propose our traditional Hoare-style program logic 
for \sparc{} in Sec.~\ref{sec:logic} and show 
