...
% =======
Then, in \Sec{\ref{sec:logic}}, we use a 
simplified version of our program logic, which 
doesn't support refinement verification, to 
present how our logic supports the three main 
features of \sparc{}. 
How to support refinement verification in 
program logic is orthogonal to our main idea 
to support modular reasoning about 
the features of \sparc{} in program logic. 
