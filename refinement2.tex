...
\begin{itemize}
    ...
    in low-level. 
    And the delay buffer is also no longer needed 
    in Pseudo-SPARCv8 program state. 
    % omit them 
...
the $\regcwp$ is omitted because the register window
is abstracted away as introduced.
