...
The number of register windows is {\it limited}, it is required 
to be saved into stack frame when overflow occurs. 
...
establish the states relation as an {\it invariant} 
...
$\Mem_T$ saving the contexts of the ready threads; a singleton memory 
...
We also restrict that the execution of 
abstract assembly primitive should satisfy {\it locality}, 
which means that if an abstract assembly primitive 
