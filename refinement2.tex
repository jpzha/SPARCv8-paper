...
The restriction is that the stack pointer of each procedure, 
...
implementation will store the contexts saved in 
...
\begin{itemize}
    ...
    its execution shouldn't modify 
    the value of \spreg{} in the window restored.
    ...
    roles, for example, \regwim{} marks which window is 
...
$(\block, \fm_1, \fm_2)$, which is used to save 
