...
\begin{figure}[!h]
    ...
    \[ 
        \begin{array}{lll}
            ...
            \llnum & \call{} & \texttt{window}\_\texttt{save} \\
            \llnum & \nop{} \\
            \llnum & \jmp{} & \SaveUsedWin \\
            \llnum & \nop{} \\
            \\[-5pt]
            \multicolumn{3}{l}
                {
                    \quad \texttt{switch}\_\texttt{new}\_\texttt{task}: 
                } \\
...
because the number of the register windows is 8. So, assigning 20 tokens 
            ...
            \multicolumn{3}{l}
            {
                ...
                \left\{
                    \begin{array}{l}
                        ...
                        \thrdid_c \neq \thrdid_n) \sepstar \metricAst{2} \sepstar \\
                        \quad 
                        \RelCurT{\thrdid_c}{\RFile}{(\RFile, \nil)}{\hthrdlocalst_c}
                        \sepstar
                        \RelRdyT{\thrdid_n}{\nst}{\hthrdlocalst_n} \sepstar 
